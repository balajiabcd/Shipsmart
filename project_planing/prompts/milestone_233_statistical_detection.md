# Milestone #233: Implement Statistical Anomaly Detection
...
```python
# src/anomaly/statistical_detection.py
...
class StatisticalAnomalyDetector:
    ...
    def fit(self, data: pd.Series):
        ...
        self.baseline_stats['iqr'] = self.baseline_stats['q3'] - self.baseline_stats['q1']
